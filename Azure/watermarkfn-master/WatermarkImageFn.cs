...
namespace DemoFn {
    public static class WatermarkImageFn {
        ...
        public static void Run ([BlobTrigger ("images/{name}", Connection = "Storage_Connection")] Stream image, [Blob ("outputs/{name}", FileAccess.Write)] Stream outImage,
            string name,
            ILogger log) {
            ...
            //sameerwatermarkfunctionapp my function app name in Azure
        }
